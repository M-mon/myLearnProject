...
/**
 * @Description 利用“访问者（Visitor）模式”模拟艺术公司与造币公司的功能。
 * @auther hasee
 * @create 2019-11-28 11:34
 */
...
class MaterialWin extends JFrame implements ItemListener {
    ...
    void showPicture(String Cuprum, String paper) {
        ...
        String FileName1 = "/MyLearnProject/untitled/src/main/java/design_pattern/visitor/Picture/" + Cuprum + ".jpg";
        String FileName2 = "/MyLearnProject/untitled/src/main/java/design_pattern/visitor/Picture/" + paper + ".jpg";
