...
class DatingGameWin extends JFrame implements ActionListener {
    ...
    DatingGameWin() {
        ...
        FileName = "/MyLearnProject/untitled/src/main/java/design_pattern/memento/Photo/四大美女.jpg";
    ...
    void showPicture(String name) {
        ...
        EastJP.repaint(); //刷新屏幕
        you.setWife(name);
        FileName = "/MyLearnProject/untitled/src/main/java/design_pattern/memento/Photo/" + name + ".jpg";
        g = new JLabel(new ImageIcon(FileName), JLabel.CENTER);
        EastJP.add(g);
